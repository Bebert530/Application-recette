...
export default function RecipeDetailScreen() {
  ...
  return <View flex={1} backgroundColor="$color1"><ScrollView showsVerticalScrollIndicator={false}>
    <View height={280} backgroundColor="$color3" overflow="hidden">{recipe.imageUrl ? <Image source={{ uri: recipe.imageUrl }} style={{ width: '100%', height: '100%' }} resizeMode="cover" /> : <YStack flex={1} alignItems="center" justifyContent="center" backgroundColor="#2A1F1A"><ChefHat size={80} color="#9A7B6B" opacity={0.3} /></YStack>}<View position="absolute" bottom={0} left={0} right={0} height={120} style={{ backgroundImage: 'linear-gradient(to top, rgba(26,18,14,1), transparent)' }} /></View>
